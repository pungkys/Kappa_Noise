...
def konno_ohmachi_smoothing_window(frequencies, center_frequency, bandwidth):
    ...
    */
    ...
    a= np.sin(bandwidth * np.log10(np.divide(frequencies, center_frequency)))
    b= (bandwidth * np.log10(np.divide(frequencies,center_frequency)))
    smoothing_window = pow((np.divide(a, b)), 4)
